...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                        KC_SPC,                                 MO(1),   MO(2),   MO(3),   MO(4)
    ),

    [1] = LAYOUT_60_ansi(
        KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LRPN, KC_RPRN, KC_UNDS, KC_PLUS, KC_DEL,
        _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LCBR, KC_RCBR, KC_PIPE,
        _______, KC_GRV,  KC_TILD, KC_BSLS= _______, _______, _______, _______, _______, _______, _______, _______,          _______,
