 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Alt | GUI  | GUI  | MO 1 |  SPC |  RET | MO 2 | BSPC | GUI  |  Alt | RET  |
 * `-----------------------------------------------------------------------------------'
 */
[0] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_LGUI, MO(1), KC_SPC, KC_ENT,  MO(2), KC_BSPC, KC_RGUI, KC_RALT, KC_ENT
),
...
[1] = LAYOUT_ortho_4x12(
    ...
    _______, _______, _______,  _______, _______, _______, _______, MO(3),   KC_DEL,  _______, _______, _______
),
...
[2] = LAYOUT_ortho_4x12(
    ...
    _______, KC_GRV,  KC_TILD, KC_BSLS, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, _______, KC_PIPE, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
