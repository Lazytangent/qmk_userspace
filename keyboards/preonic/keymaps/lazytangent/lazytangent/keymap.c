 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Alt  | GUI  | GUI  |Lower |    Space    |Raise | BSpc | Del  |  Alt | Enter|
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_ESC,  KC_LALT, KC_LGUI, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_BSPC, KC_DEL,  KC_RALT, KC_ENT   \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_GRV,  KC_TILD, KC_PIPE, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, \
  _______, _______, _______, KC_BSLS, _______, _______, KC_PGUP, KC_END,  KC_HOME, KC_PGDN, _______, _______, \
