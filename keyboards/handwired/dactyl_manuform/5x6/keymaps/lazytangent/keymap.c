...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_5x6(
        _______, _______, _______, _______, _______, _______,                    _______, _______, _______, _______, _______, _______,
        _______, MS_BTN2, MS_UP,   MS_BTN1, MS_WHLU, _______,                    _______, KC_P7,   KC_P8,   KC_P9,   _______, _______,
        _______, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD, _______,                    _______, KC_P4,   KC_P5,   KC_P6,   _______, _______,
        _______, _______, MS_WHLL, MS_WHLR, _______, _______,                    _______, KC_P1,   KC_P2,   KC_P3,   _______, _______,
