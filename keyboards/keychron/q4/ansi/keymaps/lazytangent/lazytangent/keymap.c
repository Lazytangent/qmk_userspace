...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_61(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,                            KC_SPC,                             KC_RCMD,  MO(_FN1), KC_RALT,  KC_RCTL
    ),
    ...
    [_FN1] = LAYOUT_ansi_61(
        ...
        _______, _______,  _______,                            _______,                            _______,  _______,  MO(_FN2), _______
    ),
    ...
    [_FN2] = LAYOUT_ansi_61(
        ...
        _______,           _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,            _______,
        _______, _______,  _______,                            _______,                            _______,  _______,  _______,  MO(_FN3)
    ),
