...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ansi_69(
        ...
        KC_LCTL, KC_LOPT,  KC_LCMD,           KC_SPC,           MO(2),    MO(3),            KC_BSPC,           KC_RCMD,            KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [2] = LAYOUT_ansi_69(
        _______, KC_F1,    KC_F2,    KC_F3,   KC_F4,   KC_F5,   KC_F6,    KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   QK_BOOT,          QK_BOOT,
        _______, MS_BTN1,  MS_UP,    MS_BTN1, MS_WHLU, _______, _______,  _______, _______, _______, _______,  _______,  _______,  QK_BOOT,          _______,
    ...
    [3] = LAYOUT_ansi_69(
        ...
        _______, _______,  _______,           MO(4),            _______,  _______,          MO(2),             _______,            _______, _______, _______
    )
};
