...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Base */
    ...
    KC_LALT,          KC_LGUI, MO(1),            KC_SPC,           KC_BSPC,          MO(2),                     KC_LEFT, KC_DOWN, KC_RIGHT
  ),
  [1] = LAYOUT( /* FN */
    ...
    _______, _______, _______, KC_PIPE, KC_LCBR, KC_RCBR, _______, KC_LBRC, KC_RBRC, _______, _______, _______, _______, _______,
    _______,          _______, _______,          _______,          KC_DEL,           MO(3),                     _______, _______, _______
  ),
  [2] = LAYOUT( /* FN2 */
    ...
    _______, _______, MS_WHLL, MS_WHLR, _______, _______, MO(3),   _______, _______, _______, _______, _______, _______, _______,
