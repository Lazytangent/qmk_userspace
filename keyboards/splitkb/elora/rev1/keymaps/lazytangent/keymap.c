...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_myr(
      ...
      KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LALT,MO(2),    MO(2)  , KC_RCTL, KC_N ,   KC_M ,   KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                  MO(4) , KC_LSFT, KC_LGUI, MO(1)  ,KC_SPC ,  KC_ENT , MO(1)  ,KC_BSPC,  KC_RSFT, MO(4),
