...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  QK_LEAD,
    ...
    [1] = LAYOUT_65_ansi(
        ...
        _______, MS_BTN2, MS_UP,   MS_BTN1, MS_WHLU, _______, _______, _______, _______, _______, _______, _______, QK_LEAD, QK_BOOT, _______,
        _______, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLD, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
        _______,          _______, _______, MS_WHLL, MS_WHLR, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______,                            _______,                   KC_RGUI, MO(2),   _______, _______, _______, _______
    ),
    [2] = LAYOUT_65_ansi(
