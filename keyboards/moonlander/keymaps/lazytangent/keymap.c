...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(
        ...
        KC_LCTL, KC_LALT, ALT_CTL, KC_LGUI, MO(1),            QK_LEAD,           QK_LEAD,          MO(2),   KC_RGUI, ALT_CTL, KC_RALT, KC_RCTL,
                                            KC_SPC,  MO(2),   KC_LGUI,           MO(1),   KC_ENT,  KC_BSPC
    ),
    ...
    [1] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, _______,          _______,           _______,          MO(3),   _______, _______, _______, MO(3),
