...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_1] = LAYOUT(
        ...
        _______, L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, U_T_AGCR,_______, RGB_M_P, _______, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD, \
        _______, L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, _______, _______, _______, _______, RGB_M_B, _______, _______, \
